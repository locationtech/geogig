native-image --no-server \
    ...
    -H:Name=geogig \
    -H:ReflectionConfigurationFiles=reflections.json,../core/target/classes/META-INF/native-image/picocli-generated/reflect-config.json,target/classes/META-INF/native-image/picocli-generated/reflect-config.json \
