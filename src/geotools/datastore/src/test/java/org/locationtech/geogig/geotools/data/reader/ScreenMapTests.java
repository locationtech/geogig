...
public class ScreenMapTests {
    ...
    public void testFeatureScreenMapPredicate() throws SchemaException {
        ...
        SimpleFeature feature1 = DataUtilities.createFeature(lineType,
                "LINESTRING(0.1 0.1, 0.9 0.9)|dave|7");
        SimpleFeature feature2 = DataUtilities.createFeature(lineType,
                "LINESTRING(0.1 0.1, 0.9 0.9)|dave|7");
        ...
        assertTrue(
                sm.canSimplify(((Geometry) feature1.getDefaultGeometry()).getEnvelopeInternal()));
        assertTrue(
                sm.canSimplify(((Geometry) feature2.getDefaultGeometry()).getEnvelopeInternal()));
