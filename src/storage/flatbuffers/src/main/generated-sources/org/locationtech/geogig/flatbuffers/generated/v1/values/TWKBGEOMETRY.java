...
public final class TWKBGEOMETRY extends Table {
  public static TWKBGEOMETRY getRootAsTWKBGEOMETRY(ByteBuffer _bb) { return getRootAsTWKBGEOMETRY(_bb, new TWKBGEOMETRY()); }
  public static TWKBGEOMETRY getRootAsTWKBGEOMETRY(ByteBuffer _bb, TWKBGEOMETRY obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public TWKBGEOMETRY __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createTWKBGEOMETRY(FlatBufferBuilder builder,
      int valueOffset) {
    builder.startObject(1);
    TWKBGEOMETRY.addValue(builder, valueOffset);
    return TWKBGEOMETRY.endTWKBGEOMETRY(builder);
  }

  public static void startTWKBGEOMETRY(FlatBufferBuilder builder) { builder.startObject(1); }
  ...
  public static int endTWKBGEOMETRY(FlatBufferBuilder builder) {
