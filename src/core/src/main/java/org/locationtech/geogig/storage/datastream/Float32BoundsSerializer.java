 ...
 * NOTE: the envelope MUST be represented by float32 numbers
 *       (i.e. e.getMinX() can be exactly represented by a float32)
 *
...
class Float32BoundsSerializer {
    ...
    /**
     * we assume this is properly aligned on float32 bounds
    ...
    public static int[] serialize(Envelope e) {
        ...
        if ( (xmin > e.getMinX()) || (ymin > e.getMinY()) || (xmax < e.getMaxX()) || (ymax < e.getMaxY()))
