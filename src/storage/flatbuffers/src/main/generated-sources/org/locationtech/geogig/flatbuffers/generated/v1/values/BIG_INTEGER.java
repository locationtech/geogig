...
public final class BIG_INTEGER extends Table {
  public static BIG_INTEGER getRootAsBIG_INTEGER(ByteBuffer _bb) { return getRootAsBIG_INTEGER(_bb, new BIG_INTEGER()); }
  public static BIG_INTEGER getRootAsBIG_INTEGER(ByteBuffer _bb, BIG_INTEGER obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public BIG_INTEGER __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createBIG_INTEGER(FlatBufferBuilder builder,
      int valueOffset) {
    builder.startObject(1);
    BIG_INTEGER.addValue(builder, valueOffset);
    return BIG_INTEGER.endBIG_INTEGER(builder);
  }

  public static void startBIG_INTEGER(FlatBufferBuilder builder) { builder.startObject(1); }
  ...
  public static int endBIG_INTEGER(FlatBufferBuilder builder) {
