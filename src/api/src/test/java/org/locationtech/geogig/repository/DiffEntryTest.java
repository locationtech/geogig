...
public class DiffEntryTest {
    ...
    public void testConstructorAndAccessors() {
        ...
        assertEquals(node.getName(), entry.name());
        assertEquals(node.getType(), entry.oldObjectType().orElseThrow());
        ...
        assertTrue(entry.newObjectType().isEmpty());
        ...
        assertFalse(entry.oldObjectType().isPresent());
        ...
        assertEquals(node.getType(), entry.newObjectType().orElseThrow());
        ...
        assertEquals(node2.getName(), entry.name());
        assertEquals(node2.getType(), entry.newObjectType().orElseThrow());
