 ...
 *
 */
public class ExportWebOpAsyncRepresentation extends AsyncCommandRepresentation<Optional<OSMReport>> {

    public ExportWebOpAsyncRepresentation(MediaType mediaType, AsyncCommand<Optional<OSMReport>> cmd,
            String baseURL) {
    ...
    public static class Factory implements CommandRepresentationFactory<Optional<OSMReport>> {
        ...
        public AsyncCommandRepresentation<Optional<OSMReport>> newRepresentation(
            ...
            return new ExportWebOpAsyncRepresentation(mediaType, cmd, baseURL);
        }
